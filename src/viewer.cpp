...
Viewer::Viewer(bool fullscreen, bool deterministic)
    ...
    mMeshShader63.init("mesh_shader_63",
        std::string((const char *)shader_mesh_vert, shader_mesh_vert_size),
        std::string((const char *)shader_mesh_frag, shader_mesh_frag_size),
        std::string((const char *)shader_mesh_geo, shader_mesh_geo_size));
    ...
    mPointShader63.init("point_shader_63",
        std::string((const char *)shader_point_vert, shader_point_vert_size),
        std::string((const char *)shader_mesh_frag, shader_mesh_frag_size),
        std::string((const char *)shader_point_geo, shader_point_geo_size));
    ...
    mOrientationFieldShader.init("orientation_field_shader",
        std::string((const char *)shader_orientation_field_vert, shader_orientation_field_vert_size),
        std::string((const char *)shader_orientation_field_frag, shader_orientation_field_frag_size),
        std::string((const char *)shader_orientation_field_geo, shader_orientation_field_geo_size));

    mPositionFieldShader.init("position_field_shader",
        std::string((const char *)shader_position_field_vert, shader_position_field_vert_size),
        std::string((const char *)shader_position_field_frag, shader_position_field_frag_size));

    mPositionSingularityShader.init("position_singularity_shader",
        std::string((const char *)shader_singularity_vert, shader_singularity_vert_size),
        std::string((const char *)shader_singularity_frag, shader_singularity_frag_size),
        std::string((const char *)shader_singularity_geo, shader_singularity_geo_size));
    ...
    mFlowLineShader.init("flowline_shader",
        std::string((const char *)shader_flowline_vert, shader_flowline_vert_size),
        std::string((const char *)shader_flowline_frag, shader_flowline_frag_size));
    ...
    mOutputMeshShader.init("output_mesh_shader",
        std::string((const char *)shader_quadmesh_vert, shader_quadmesh_vert_size),
        std::string((const char *)shader_quadmesh_frag, shader_quadmesh_frag_size));

    mOutputMeshWireframeShader.init("output_mesh_wireframe_shader",
        std::string((const char *)shader_lines_vert, shader_lines_vert_size),
        std::string((const char *)shader_lines_frag, shader_lines_frag_size));
...
void Viewer::computeCameraMatrices(Eigen::Matrix4f &model,
    ...
    model = model * nanogui::scale(Eigen::Vector3f::Constant(mCamera.zoom * mCamera.modelZoom));
    model = model * nanogui::translate(mCamera.modelTranslation);
}
